...
<div class="col-sm-12 col-md-8" style="box-shadow: 0px 0px 10px teal; ">
    <div class="thumbnail" style=" border-radius: 0px; ">
                <img src="<?php echo base_url('assist/images/slider/'); ?><?php echo $profile->images; ?>" alt="N/A" class="img img-responsive" style="height: 220px; width:100%;">
        <div class="form">
            <?php echo form_open_multipart('Slideroptions/GalleryUpdateForm'); ?>
              <input type="hidden" name="old_image" value="<?php echo $profile->images; ?>">
