        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>
                            Gallery & Photos Control Options !
                    ...
                    <h5>Wellcome to Gallery & Photos Control Options !</h5>
...
?>
 <div class="col-sm-12 col-md-4">
    <div class="thumbnail" style="border-radius: 0px; ">
      <img src="<?php echo base_url('assist/images/gallery/'); ?><?php echo $management->image; ?>" alt="" style="width:100%; height:200px;">
      <div class="caption">
        <p>
            <a href="<?php echo base_url('index.php/Galleryoptions/GalleryUpdate/'); ?><?php echo $management->id; ?>/<?php echo $management->image; ?>" class="btn btn-warning btn-sm" style="border-radius: 0px;" >Update</a>
            <a href="<?php echo base_url('index.php/Galleryoptions/RemoveProfile/'); ?><?php echo $management->id; ?>/<?php echo $management->image; ?>" class="btn btn-danger btn-sm" style="border-radius: 0px;" >Remove</a>  
        </p>
      </div>
    </div>
  </div>
...
?>
   ...
   <div class="col-sm-12 col-md-4">
    <div class="thumbnail" style="background: rgba(0,0,0,0.9); border-radius: 0px; color: white;">
        <div class="form">
            <?php echo form_open_multipart('Galleryoptions/GalleryAddForm'); ?>
